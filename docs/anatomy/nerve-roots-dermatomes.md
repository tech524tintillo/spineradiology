...
<figure markdown="span">
  ![Dermatome map](../assets/images/anatomy/dermatome-map.png){ width="500" }
  <figcaption>Dermatome distribution map showing the cutaneous areas supplied by each spinal nerve root. (Grant's Atlas, public domain)</figcaption>
</figure>
...
!!! note "Far Lateral Herniations"
    Far lateral (foraminal) disc herniations compress the **exiting nerve root** rather than the traversing root. A far lateral L4–L5 herniation affects the **L4 nerve root**, not L5. This distinction is critical for accurate clinical-imaging correlation. See [Far Lateral Disc Herniation](../degenerative-disease/far-lateral-disc-herniation.md).
...
- [Lumbar Disc Herniation](../degenerative-disease/lumbar-disc-herniation.md)
- [Cervical Disc Herniation](../degenerative-disease/cervical-disc-herniation.md)
- [Far Lateral Disc Herniation](../degenerative-disease/far-lateral-disc-herniation.md)
- [Radiculopathy — Imaging Correlation](../special-topics/radiculopathy.md)
- [Cauda Equina Syndrome](../special-topics/cauda-equina-syndrome.md)
- [Schwannoma](../neoplasms/schwannoma.md)
