...
- **Direct trauma** — A blow to the posterior midline of the spine
- **Avulsion** — Forceful flexion against contracted extensor muscles, pulling the spinous process via the supraspinous and interspinous ligaments. This is the mechanism of the classic clay shoveler fracture (typically C6, C7, or T1).
- **Hyperflexion** — The spinous process may fracture as part of a larger flexion-distraction injury when posterior tension band forces exceed the strength of the bone
- **Stress fracture** — Repetitive loading, particularly in athletes
...
### Radiography
- **Lateral view** — A fracture line through the spinous process, which may appear as a "double spinous process" sign when the fragment is displaced inferiorly
- Can be difficult to visualize, especially in the cervicothoracic region where overlapping structures obscure detail

### CT
- Fracture lines through the spinous process on sagittal and axial images
- Degree of displacement
- CT is important to evaluate for associated injuries — lamina fractures, facet fractures, or vertebral body fractures that would indicate a more significant injury pattern
...
The clay shoveler fracture is a specific subtype of spinous process fracture — an avulsion fracture of the lower cervical or upper thoracic spinous process (C6, C7, or T1) caused by muscular avulsion forces. See the [Clay Shoveler Fracture](clay-shoveler-fracture.md) article for a detailed discussion.
...
- Spinous process fractures are stable, posterior column-only injuries (AO Type A0)
- Most common at C6–T3 from avulsion or direct trauma
- The "double spinous process" sign on lateral radiograph suggests a displaced fragment
...
- [Transverse Process Fractures](transverse-process-fractures.md)
- [Chance Fracture](chance-fracture.md)
